...
#
# DESCRIPTION:
#	logicalrefquota should be sent-and-received, but it should not interfere with
...
#	5. Create a logicalrefquota larger than one file, but smaller than both.
...
log_assert "logicalrefquota is properly sent-and-received, regardless of any " \
...
#	5. Create a logicalrefquota larger than one file, but smaller than both.
log_must $ZFS set logicalrefquota=8M $orig
...
log_pass "logicalrefquota is properly sent-and-received, regardless of any " \
	"intermediate snapshots sent by a replication stream."
