...
#
# DESCRIPTION:
#	logicalrefquota, like regular quota, is loosely enforced.  A dataset
#	can exceed its logicalrefquota by one transaction.  This loose
#   enforcement used to cause problems upon receiving a datastream where
#   its logicalrefquota is slightly exceeded.  This test confirms that
#   we can successfully receive a slightly over logicalrefquota stream.
#
# STRATEGY:
#	1. Create a filesystem.
#	2. Set a logicalrefquota.
...
log_assert "The allowable slight logicalrefquota overage is properly sent-and-" \
	"received."
log_onexit cleanup
...
#	2. Set a logicalrefquota.
log_must $ZFS set logicalrefquota=50M $orig
...
log_pass "Verified receiving a slightly-over-logicalrefquota stream succeeds."
